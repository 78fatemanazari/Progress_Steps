...
<!-- PROJECT DESCRIPTION -->
# 📖 [Progress Steps] <a name="about-project"></a>

**Progress Steps** is simple project built with html, css and javaScript to show the progress of something.
...
```sh
  ...
  git clone git@github.com:78fatemanazari/Progress_Steps.git
```
